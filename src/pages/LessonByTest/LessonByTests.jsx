...
import {deleteLessonByTest, getLessonsByTests} from "../../features/LessonsByTests/LessonsByTestsSlice";
...
const LessonByTests = () => {
	...
	const {loading, lessonByTestsList} = useSelector(({lessonByTest}) => lessonByTest)
